...
MobileProfileString:         db "  Profil mobile@"
MobileString_Gender:         db "Genre@"
MobileString_Age:            db "Age@"
MobileString_Address:        db "Adresse@"
MobileString_ZipCode:        db "Code postal@"
MobileString_OK:             db "OK@"
MobileString_ProfileChanged: db "Profil modifié@"
...
Prefectures: ; Some names shortened to fit, check for official initials later.
	db	"BE-VAN@"	;Antwerpen
	db	"BE-VBR@"	;Vlaams-Brabant
	db	"BE-VLI@"	;Limburg
	db	"BE-VOV@"	;Oost-Vlaanderen
	db	"BE-VWV@"	;West-Vlaanderen
	db	"BE-WBR@"	;Brabant wallon
	db	"BE-WHT@"	;Hainaut
	db	"BE-WLG@"	;Liège
	db	"BE-WLX@"	;Luxembourg
	db	"BE-WNA@"	;Namur
	db	" CH-AG@"	;Aargau
	...
	db	" CH-ZH@"	;Zürich
	db	"FR-20R@"	;Corse
	db	"FR-ARA@"	;Auvergne-Rhône-Alpes
	db	"FR-BFC@"	;Bourgogne-Franche-Comté
	db	"FR-BRE@"	;Bretagne
	db	"FR-CVL@"	;Centre-Val de Loire
	db	"FR-GES@"	;Grand-Est
	db	"FR-HDF@"	;Hauts-de-France
	db	"FR-IDF@"	;Île-de-France
	db	"FR-NAQ@"	;Nouvelle-Aquitaine
	db	"FR-NOR@"	;Normandie
	db	"FR-OCC@"	;Occitanie
	db	"FR-PAC@"	;Provence-Alpes-Côte-d’Azur
	db	"FR-PDL@"	;Pays-de-la-Loire
	db	" LU-CA@"	;Capellen
	db	" LU-CL@"	;Clervaux
	db	" LU-DI@"	;Diekirch
	db	" LU-EC@"	;Echternach
	db	" LU-ES@"	;Esch-sur-Alzette
	db	" LU-GR@"	;Grevenmacher
	db	" LU-LU@"	;Luxembourg
	db	" LU-ME@"	;Mersch
	db	" LU-RD@"	;Redange
	db	" LU-RM@"	;Remich
