...
.asm_48113
	...
	ld d, h
	ld e, l
	hlcoord 12, 9 ; Default Prefectures position in MOBILE menu
	call PlaceString 
...
.asm_483d5
	...
	call ClearBox
	hlcoord 12, 9 ; Prefectures position when selected
	call PlaceString
	ret
...
.Items:
	db 60 ; The number of locations in the prefectures list (-1 because it starts at 0)
x = 0
rept 60 ; The number of locations in the prefectures list (-1 because it starts at 0)
	db x
x = x + 1
endr
	db -1
...
Antwerpen:							db	"BE-VAN@"	;Antwerpen
Vlaams_Brabant:						db	"BE-VBR@"	;Vlaams-Brabant
Limburg:							db	"BE-VLI@"	;Limburg
Oost_Vlaanderen:					db	"BE-VOV@"	;Oost-Vlaanderen
West_Vlaanderen:					db	"BE-VWV@"	;West-Vlaanderen
Brabant_wallon:						db	"BE-WBR@"	;Brabant wallon
Hainaut:							db	"BE-WHT@"	;Hainaut
Liege:								db	"BE-WLG@"	;Liège
BE_Luxembourg:						db	"BE-WLX@"	;Luxembourg
Namur:								db	"BE-WNA@"	;Namur
...
Corse:								db	"FR-20R@"	;Corse
Auvergne_Rhone_Alpes:				db	"FR-ARA@"	;Auvergne-Rhône-Alpes
Bourgogne_Franche_Comte:			db	"FR-BFC@"	;Bourgogne-Franche-Comté
Bretagne:							db	"FR-BRE@"	;Bretagne
Centre_Val_de_Loire:				db	"FR-CVL@"	;Centre-Val de Loire
Grand_Est:							db	"FR-GES@"	;Grand-Est
Hauts_de_France:					db	"FR-HDF@"	;Hauts-de-France
Ile_de_France:						db	"FR-IDF@"	;Île-de-France
Nouvelle_Aquitaine:					db	"FR-NAQ@"	;Nouvelle-Aquitaine
Normandie:							db	"FR-NOR@"	;Normandie
Occitanie:							db	"FR-OCC@"	;Occitanie
Provence_Alpes_Cote_dAzur:			db	"FR-PAC@"	;Provence-Alpes-Côte-d’Azur
Pays_de_la_Loire:					db	"FR-PDL@"	;Pays-de-la-Loire
Capellen:							db	" LU-CA@"	;Capellen
Clervaux:							db	" LU-CL@"	;Clervaux
Diekirch:							db	" LU-DI@"	;Diekirch
Echternach:							db	" LU-EC@"	;Echternach
Esch_sur_Alzette:					db	" LU-ES@"	;Esch-sur-Alzette
Grevenmacher:						db	" LU-GR@"	;Grevenmacher
Luxembourg:							db	" LU-LU@"	;Luxembourg
Mersch:								db	" LU-ME@"	;Mersch
Redange:							db	" LU-RD@"	;Redange
Remich:								db	" LU-RM@"	;Remich
Vianden:							db	" LU-VD@"	;Vianden
Wiltz:								db	" LU-WI@"	;Wiltz
...
.asm_48b8d ; press up, zip code number menu
	...
	ld b, a
	and $f
	cp $9 ; Controls how far you can scroll through digitstrings in zip code menu
	ld a, b
	jr c, .asm_48b9a
	and $f0
	add $ff
