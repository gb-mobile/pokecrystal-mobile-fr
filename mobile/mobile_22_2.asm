...
Function8b555:
.loop
	ld hl, UnknownText_0x8b5ce ; Please enter any four-digit number.
	call PrintText
	ld bc, wd017
	call Function8b45c
	jr c, .asm_8b5c8
	...
	call Function8b664
	jr nz, .asm_8b57c
	ld hl, UnknownText_0x8b5e2 ; 0000 is invalid!
	call PrintText
	jr .loop

.asm_8b57c
	ld hl, UnknownText_0x8b5d3 ; Enter the same number to confirm.
	call PrintText
	ld bc, wd013
	call Function8b45c
	jr c, .loop
	...
	ld bc, wd013
	call Mobile22_DisplayPINCodeAndFrame
	ld hl, UnknownText_0x8b5d8 ; That's not the same number.
	call PrintText
	jr .asm_8b57c
...
.strings_equal
	...
	ld bc, wd013
	call Mobile22_DisplayPINCodeAndFrame
	ld hl, UnknownText_0x8b5dd ; Your PASSCODE has been set.
	call PrintText
	and a
.asm_8b5c8
	push af
...
String_8b90b: db "Choisissez CARTE.@"        ; Please select a noun.
String_8b919: db "Déplacer où ?@"    ; OK to swap with any noun?
String_8b92a: db "Choisissez un ami.@"        ; Please select an opponent.
String_8b938: db "Mettre où ?@" ; Please select a location.
