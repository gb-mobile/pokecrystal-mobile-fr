...
ExchangeDownloadURL:
	db "http://gameboy.datacenter.ne.jp/cgb/download?name=/01/CGB-BXTF/exchange/index.txt", 0

BattleDownloadURL:
	db "http://gameboy.datacenter.ne.jp/cgb/download?name=/01/CGB-BXTF/battle/index.txt", 0

NewsDownloadURL:
	db "http://gameboy.datacenter.ne.jp/cgb/download?name=/01/CGB-BXTF/news/index.txt", 0

MenuDownloadURL:
	db "http://gameboy.datacenter.ne.jp/cgb/download?name=/01/CGB-BXTF/POKESTA/menu.cgb", 0

IndexDownloadURL:
	db "http://gameboy.datacenter.ne.jp/cgb/download?name=/01/CGB-BXTF/tamago/index.txt", 0
...
;	ld [hli], a
	...
	ld a, LOW($c708) ; memory location of login information
	ld [hli], a
	ld a, HIGH($c708)
	ld [hli], a
	...
	ld de, $de00 ; buffer location
	ld bc, $0200 ; buffer size
	ld a, $2c
	jp Function119e2b
